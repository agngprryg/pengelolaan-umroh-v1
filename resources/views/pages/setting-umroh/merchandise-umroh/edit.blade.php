        ...
        <div class="col-lg-12">
            <div class="card   rounded">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <h3 class="mb-2">Edit Data Kelengkapan Registrasi Umroh</h3>
                        </div>
                    </div>

                    <div class="mt-5 container">
                        <form action="{{ route('merchandise-umroh.update', $data->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_merchandise" id="nama_merchandise" class="form-control"
                                    value="{{ $data->nama_merchandise }}" required>
                            </div>
