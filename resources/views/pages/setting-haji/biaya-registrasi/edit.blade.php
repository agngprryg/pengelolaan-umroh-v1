            ...
            <div class="card   rounded">
                <div class="card-body">
                    ...
                    <div class="mt-5 container">
                        <form action="{{ route('biaya-registrasi.update', $data->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tahun" class="form-select" required>
                                    ...
                                    @for ($year = date('Y'); $year >= 2000; $year--)
                                        <option value="{{ $year }}"
                                            {{ $year == $data->tahun ? 'selected' : '' }}>{{ $year }}</option>
                                    @endfor
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="jumlah_biaya" id="jumlah_biaya" class="form-control"
                                    value="{{ $data->jumlah_biaya }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="rincian_biaya" id="rincian_biaya" class="form-control"
                                    value="{{ $data->rincian_biaya }}" required>
                            </div>
